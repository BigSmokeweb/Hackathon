...
export function TripStateBar({
  ...
  return (
    <div
      id="trip-state-bar"
      className="sticky top-16 z-30 bg-[#F5F1E6]/95 backdrop-blur-2xl border-b border-[#C4A265] shadow-sm text-[#2C2C2C]"
    >
        ...
        <div className="flex items-center justify-between gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="font-manifold font-bold text-[#2C2C2C] text-sm mt-0.5">{selectedCount}</p>
            </div>
          </div>
          ...
          <div className="flex-1 min-w-[140px] max-w-[200px]">
            <div className="flex items-center justify-between text-[10px] font-mono text-[#5C6460] mb-1">
              <span>Budget</span>
              <span className="font-bold text-[#2C2C2C]">₹{Math.round(remainingBudget)}</span>
            </div>
            <div className="w-full bg-[#D4CFC0] rounded-full h-1.5 overflow-hidden">
              <div
          ...
          {/* Weather status */}
          {isAdverseWeather && (
            <div className="flex items-center gap-1.5 bg-[#8B7355]/15 border border-[#8B7355]/30 text-[#347F8C] text-[11px] font-mono px-3 py-1 rounded-full">
              <span>Forecast:</span>
