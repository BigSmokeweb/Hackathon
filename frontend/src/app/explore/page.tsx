    ...
    <div className="bg-[#F7F4EA] text-[#3E4541] min-h-screen pt-28 pb-24 selection:bg-[#4FA3D1]/30 selection:text-[#3E4541]">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        ...
        <div className="mt-8 flex flex-col xl:flex-row xl:items-center justify-between gap-4">
          ...
          {/* Search & City Select Controls */}
          <form
            action="/explore"
            method="GET"
            className="flex items-center gap-2 bg-white/95 border border-[#D8D4C8] p-1.5 rounded-2xl focus-within:border-[#347F8C] transition-colors shadow-sm shrink-0 self-start xl:self-auto"
          >
              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <h2 className="font-manifold font-extrabold uppercase text-lg sm:text-xl tracking-wide text-[#3E4541] group-hover:text-[#347F8C] transition-colors line-clamp-2 leading-snug">
                      {exp.title}
                    </h2>
